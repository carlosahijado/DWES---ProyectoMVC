<section class="container">
      <div class="row text-center">
        <div class="col-lg-8 col-md-10 mx-auto">
          ...
          <img src="data:image/png; base64,<?php echo $transformarABase64; ?>" width="100%">
          <?php endif;?>
          ...
          <hr>
          <div class="clearfix">
            <a class="btn btn-primary float-right" href="<?php echo URL_BASE?>/noticia/mostrar">Volver</a>
          </div>
        </div>
      ...
      <?php foreach($comentarios as $comentario):?>
      	...
      	<div class="row border border-info mb-4 p-3 comentarios">
      		...
      		<?php if($comentario->getIdusuario() == $_SESSION["usuario"]->getIdusuario()):?>
      			<a href="<?php echo URL_BASE?>/comentario/borrarComentarioNoticia/<?php echo $comentario->getIdcomentario()?>" class="col-md-1"><img src="<?php echo URL_BASE?>/assets/img/borrarcomentario.png" width="40%"></a>
      		<?php endif;?>
      		<?php endif;?>
      	</div>
      <?php endforeach;?>
      <?php if(isset($_SESSION["usuario"])):?>
      <hr>
      <form action="<?php echo URL_BASE;?>/comentario/insertarComentarioNoticia/<?php echo $fila->getIdnoticia();?>" method="post">
    	  <div class="form-row">
